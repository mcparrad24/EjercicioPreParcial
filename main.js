...
const col1Form = document.createElement("td");
const col2Form = document.createElement("td");
const col3Form = document.createElement("td");
const col4Form = document.createElement("td");
...
function agregarForm(elemento){
    ...
    let valores = elemento.target.elements;

    let dato = [valores[0].value, valores[1].value, valores[2].value, valores[3].value];
    data.push(dato);
    dataSorted.push(dato);
